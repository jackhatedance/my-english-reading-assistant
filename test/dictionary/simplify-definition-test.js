...
describe('simplifyDefinition test', function () {
    ...
    describe('parse', function () {
        ...
        it('stand', async function () {
            ...
            let result = simplifyDefinition('stand', null, lookupResult, null, null, null, { maxMeaningNumber: 3, hideWordClass: true });
        ...
        it('Ignorant', async function () {
            ...
            let result = simplifyDefinition('ignorant', null, lookupResult, null, null, null, { maxMeaningNumber: 3, hideWordClass: true });
        ...
        it('simplify said', async function () {
            ...
            let result = simplifyDefinition('said', null, lookupResult, 'say', null, deepLookupResult, { maxMeaningNumber: 3, hideWordClass: true });
