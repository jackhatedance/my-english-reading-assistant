    ...
    <div class="sections">
        <div class="section">
            ...
            <div class="input">
                ...
                <el-button @click="clearNotes" >{{ t('optionsClearNotesAction') }}</el-button>
            </div>
            <div class="action">
        ...
        <div class="section">
            ...
            <div class="input">
                ...
                <el-button @click="onImport" >{{ t('optionsImportNotesAction') }}</el-button>
            </div>
            <div class="action">
        ...
        <div class="section">
            ...
            <div class="input">
                <el-button @click="onExport">{{ t('optionsExportNotesAction') }}</el-button>
            </div>
            <div class="action">
